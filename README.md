...
<p>
  <img src="./assets/hero.png" alt="Academic Paper Writing Skill" width="860">
</p>

# Academic Paper Writing Skill

<p>
  <a href="https://github.com/xcl2005/academic-paper-writing-skill/stargazers"><b>GitHub stars</b></a>
  &nbsp;|&nbsp;
  <a href="https://github.com/xcl2005/academic-paper-writing-skill/network/members"><b>Forks</b></a>
  &nbsp;|&nbsp;
  <a href="https://github.com/xcl2005/academic-paper-writing-skill/blob/main/LICENSE"><b>MIT License</b></a>
  &nbsp;|&nbsp;
  <b>Agent Skills</b>
  &nbsp;|&nbsp;
  <b>Evidence First</b>
...
<p>
  <b>面向学术论文、文献综述、rebuttal 与研究写作的证据优先工作流。</b><br>
  <b>Verify sources, track claims, and write research outputs with auditable evidence.</b>
</p>
...
<p>
  ...
  &nbsp;|&nbsp;
  <a href="#-example-outputs"><b>🧪 示例产物</b></a>
  &nbsp;|&nbsp;
...
| 🧾 | Rebuttal / revision：把审稿意见、回应、补实验和措辞降调连到证据 |

## 🧪 Example Outputs

| Literature Matrix | Claim Ledger |
|---|---|
| <img src="./assets/literature-matrix-preview.png" width="480" alt="Literature Matrix Preview"> | <img src="./assets/claim-ledger-preview.png" width="480" alt="Claim Ledger Preview"> |

> These are example structures, not real paper results.
...
```text
/academic-paper-writing-skill 帮我把这篇论文的 reviewer comments 拆成 rebuttal 证据清单和回应矩阵
```
...
<p align="center">
  <img src="./assets/workflow.png" width="900" alt="Evidence-first workflow">
</p>
...
<p align="center">
  <img src="./assets/integrity-guard.png" width="900" alt="Integrity Guard">
</p>
...
Academic writing AI, research paper workflow, literature review matrix, rebuttal assistant, claim evidence mapping, research integrity, evidence-first writing, capstone evidence workflow, Codex skills, Claude Code skills, Agent Skills.
